...
class Train(QWidget):
    def __init__(self):
        ...
        self.cbcategoria.setFixedSize(600,40)
        ...
        self.izqlayout.addLayout(self.rutalayout,0,0)
        self.izqlayout.addLayout(self.algoritmolayout,1,0)
        self.izqlayout.addLayout(self.seleccionlayout, 2, 0)
